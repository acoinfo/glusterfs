...
# Target
#*********************************************************************************************************
LOCAL_TARGET_NAME := libgfrpc.so

#*********************************************************************************************************
# Source list
#*********************************************************************************************************
LOCAL_SRCS :=  \
src/rpc/rpc-lib/src/auth-glusterfs.c \
src/rpc/rpc-lib/src/auth-null.c \
src/rpc/rpc-lib/src/auth-unix.c \
src/rpc/rpc-lib/src/autoscale-threads.c \
src/rpc/rpc-lib/src/mgmt-pmap.c \
src/rpc/rpc-lib/src/rpc-clnt.c \
src/rpc/rpc-lib/src/rpc-clnt-ping.c \
src/rpc/rpc-lib/src/rpc-drc.c \
src/rpc/rpc-lib/src/rpcsvc-auth.c \
src/rpc/rpc-lib/src/rpcsvc.c \
src/rpc/rpc-lib/src/rpc-transport.c \
src/rpc/rpc-lib/src/xdr-rpcclnt.c \
src/rpc/rpc-lib/src/xdr-rpc.c
...
-lurcu-cds -lcrypto -lucontext -largp -lsunrpc
...
# Depend target
#*********************************************************************************************************
LOCAL_DEPEND_TARGET := $(OUTDIR)/libglusterfs.so
