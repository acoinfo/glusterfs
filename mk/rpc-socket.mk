...
#*********************************************************************************************************
LOCAL_SRCS :=  \
src/rpc/rpc-transport/socket/src/socket.c \
src/rpc/rpc-transport/socket/src/name.c
...
LOCAL_CXXFLAGS := 
LOCAL_LINKFLAGS := -Wl,-rpath="/lib/glusterfs/rpc-transport"
...
-lurcu-cds -lcrypto -lssl -lucontext -largp -lgfrpc -lgfxdr -lsunrpc
