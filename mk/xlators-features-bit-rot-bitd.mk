...
#--------------文件信息--------------------------------------------------------------------------------
#
# 文   件   名: xlators-features-bit-rot-bitd.mk
#
# 创   建   人: RealEvo-IDE
#
...
# Target
#*********************************************************************************************************
LOCAL_TARGET_NAME := bit-rot.so

#*********************************************************************************************************
# Source list
#*********************************************************************************************************
LOCAL_SRCS :=  \
src/xlators/features/bit-rot/src/bitd/bit-rot.c \
src/xlators/features/bit-rot/src/bitd/bit-rot-scrub.c \
src/xlators/features/bit-rot/src/bitd/bit-rot-ssm.c \
src/xlators/features/bit-rot/src/bitd/bit-rot-scrub-status.c
...
-I"src/xlators/features/bit-rot/src/stub" \
...
-lurcu-cds -lcrypto -lucontext -largp -lgfrpc -lgfxdr -lgfchangelog
...
# Depend target
#*********************************************************************************************************
LOCAL_DEPEND_TARGET := $(OUTDIR)/libglusterfs.so $(OUTDIR)/libgfrpc.so $(OUTDIR)/libgfxdr.so $(OUTDIR)/libgfchangelog.so
