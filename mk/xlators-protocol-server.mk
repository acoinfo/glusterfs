...
#--------------文件信息--------------------------------------------------------------------------------
#
# 文   件   名: xlators-protocol-server.mk
#
# 创   建   人: RealEvo-IDE
#
...
# Target
#*********************************************************************************************************
LOCAL_TARGET_NAME := server.so

#*********************************************************************************************************
# Source list
#*********************************************************************************************************
LOCAL_SRCS :=  \
src/xlators/protocol/server/src/server.c \
src/xlators/protocol/server/src/server-resolve.c \
src/xlators/protocol/server/src/server-helpers.c \
src/xlators/protocol/server/src/server-rpc-fops.c \
src/xlators/protocol/server/src/server-handshake.c \
src/xlators/protocol/server/src/authenticate.c \
src/xlators/protocol/server/src/server-common.c \
src/xlators/protocol/server/src/server-rpc-fops_v2.c
...
LOCAL_CXXFLAGS :=
LOCAL_LINKFLAGS := -Wl,-rpath="/lib/glusterfs/xlator/protocol"
