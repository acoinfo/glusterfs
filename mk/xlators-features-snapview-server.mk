...
#--------------文件信息--------------------------------------------------------------------------------
#
# 文   件   名: xlators-features-snapview-server.mk
#
# 创   建   人: RealEvo-IDE
#
...
# Target
#*********************************************************************************************************
LOCAL_TARGET_NAME := snapview-server.so

#*********************************************************************************************************
# Source list
#*********************************************************************************************************
LOCAL_SRCS :=  \
src/xlators/features/snapview-server/src/snapview-server.c \
src/xlators/features/snapview-server/src/snapview-server-mgmt.c \
src/xlators/features/snapview-server/src/snapview-server-helpers.c
