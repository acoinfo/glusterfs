...
#--------------文件信息--------------------------------------------------------------------------------
#
# 文   件   名: xlators-storage-posix.mk
#
# 创   建   人: RealEvo-IDE
#
...
# Target
#*********************************************************************************************************
LOCAL_TARGET_NAME := posix.so

#*********************************************************************************************************
# Source list
#*********************************************************************************************************
LOCAL_SRCS :=  \
src/xlators/storage/posix/src/posix.c \
src/xlators/storage/posix/src/posix-helpers.c \
src/xlators/storage/posix/src/posix-handle.c \
src/xlators/storage/posix/src/posix-aio.c \
src/xlators/storage/posix/src/posix-gfid-path.c \
src/xlators/storage/posix/src/posix-entry-ops.c \
src/xlators/storage/posix/src/posix-inode-fd-ops.c \
src/xlators/storage/posix/src/posix-common.c \
src/xlators/storage/posix/src/posix-metadata.c \
src/xlators/storage/posix/src/posix-io-uring.c
...
LOCAL_CXXFLAGS := 
LOCAL_LINKFLAGS := -Wl,-rpath="/lib/glusterfs/xlator/storage"
...
-lurcu-cds -lcrypto -lucontext -largp -lgfrpc -lgfxdr $(ACL)
